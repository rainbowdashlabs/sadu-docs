...
As an alternative you can also call a `QueryFactory` instance directly.
You can also initialise the `StaticQueryAdapter` and use the builder method from there.
